...
Pod::Spec.new do |spec|
  ...
  A cocoapods libraray for CT Audit
                   DESC
  ...
  # Or just: spec.author    = "jaymehta"
  # spec.authors            = { "jaymehta" => "jaysmehta91@gmail.com@example.com" }
  # spec.social_media_url   = "https://twitter.com/jaymehta"
  ...
  spec.source_files  = "CTiOSAudit*","Classes", "Classes/**/*.{h,m}"
